    ...
    return (
        <>
            ...
            <blockquote className="border-l-4 pl-4 mb-6 border-gray-600 italic font-semibold text-neutral-600 dark:text-gray-300">
                <span className="font-bold text-base lg:text-lg text-left">
            ...
            {/* Main Content */}
            <p className=" text-neutral-400 text-base lg:text-lg text-left mb-3">This is a story of —</p>

            {/* Title */}
            <h3 className="lg:text-xl text-lg text-neutral-400 font-bold mb-3">Imran Tahir - <i>A Nomad who finally found his home</i></h3>


            {/* Paragraph */}
            <p className="text-neutral-400 lg:text-lg text-base text-left mb-4">
            ...
            {/* Italicized Quote */}
            <p className="text-neutral-400 lg:text-lg text-base text-left mb-6">
            ...
            <p className="text-neutral-400 lg:text-lg text-base text-left mt-6 mb-4">
                Let's hear his background story first.
            </p>
            <p className="text-neutral-400 font-bold italic lg:text-lg text-base text-left mb-4">
                A Nomadic Cricketer
            </p>
            <p className="text-neutral-400 lg:text-lg text-base text-left mb-6">
